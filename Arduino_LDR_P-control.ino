...
int sensor = A5;                                                 // Associating pin A5 to the word sensor
int actuator = 9;                                                // Associating pin 9 to the word acutator
...
pinMode(7 ,INPUT);                                               // Declare the pin 7 as an input
pinMode(6 ,INPUT);                                               // Declare the pin 6 as an input
pinMode(8 ,INPUT);                                               // Declare the pin 8 as an input
...
BTN1 = digitalRead(7);                                           // BTN1 will read the current state of pin 7
BTN2 = digitalRead(6);                                           // BTN2 will read the current state of pin 6
SCRN = digitalRead(8);                                           // SCRN will read the current state of pin 8
